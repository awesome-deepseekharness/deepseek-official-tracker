...
## Thinking
5-7 sentences: which tiers you fetched, which tools (jina vs browser) you used and why, what diff you found, which secondary/community signals checked, why you concluded. Mention browser double-checks.
